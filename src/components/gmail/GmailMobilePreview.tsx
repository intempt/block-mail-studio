      ...
      {showInboxList ? (
        ...
        <div className="h-full bg-white flex flex-col">
          ...
          <div className="px-4 py-3" style={{ backgroundColor: 'var(--gmail-red)' }}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span 
                  className="text-white gmail-text-title-large gmail-font-product-sans"
                >
                  Inbox
                </span>
              </div>
          ...
          <div className="flex-1 overflow-auto gmail-scrollbar">
            {mockEmails.map((email) => (
              <div
                ...
                className={`flex items-start gap-3 p-4 border-b active:bg-gray-50 gmail-transition gmail-state-hover ${
                  email.unread ? '' : ''
                }`}
                style={{ 
          ...
          <div className="absolute bottom-6 right-6">
            <button 
              className="w-14 h-14 gmail-rounded-full gmail-elevation-3 flex items-center justify-center gmail-transition gmail-state-hover"
        ...
        <div className="h-full bg-white flex flex-col">
          ...
          {/* Action Buttons */}
          <div 
            className="bg-white border-t px-4 py-3 safe-area-bottom" 
