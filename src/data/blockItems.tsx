...
export const blockItems: BlockItem[] = [
  ...
  { id: 'button', name: 'Call-to-action', description: 'Call-to-action buttons with custom styling', icon: <MousePointer className="w-4 h-4" /> },
  ...
  { id: 'product', name: 'Product', description: 'Product showcase cards with pricing', icon: <Package className="w-4 h-4" /> },
];
